...
<div id="page-content" class="clearfix">
  <div class="row-fluid">
	<div class="row-fluid">
		<!-- 检索  -->
		<form action="provider/list" method="post" name="providerSearchForm" id="providerSearchForm">
			<div class="formWrapper form-horizontal" style="with:100%;display:flex;">
				<div class="formLeft" style="flex:1;">
					<div class="form-group">
					    <label class="control-label lableWidth100 marginRight10">供应商名称</label>
				...
				<div class="formMiddle" style="flex:1;">
					<div class="form-group">
				    	<label class="control-label lableWidth100 marginRight10">GDS</label>
					    <select class="form-control">
						  <option>Amadeus</option>
						  <option>Travelsky</option>
				...
				<div class="formRight" style="flex:1;">
					<div class="form-group">
					    <label class="control-label lableWidth100 marginRight10">PCC</label>
					    <input type="text" class="form-control" id="" placeholder="">
					</div>
