...
<body>
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<form action="provider/${provider.id == null?'addProvider':'editProvider' }" method="post" ref="providerForm" class="form-horizontal" role="form">
					...
					<div class="formWrapper form-horizontal contactGroups">
						<div class="formLeft" style="flex: 1;">
							<div class="form-group">
								<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>对接业务</label> 
								<select ref="dockingBusiness" class="form-control">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" ref="email" placeholder="">
							</div>
						</div>
						<div class="formMiddle" style="flex: 1;">
							<div class="form-group">
								<label for="fitAirline" class="control-label lableWidth100 marginRight10">中文名</label> 
								<input type="text" class="form-control" ref="chineseName" placeholder="">
							</div>
							<div class="form-group">
								<label for="fitAirline" class="control-label lableWidth100 marginRight10">QQ</label> 
								<input type="text" class="form-control" ref="qq" placeholder="">
							</div>
						</div>
						<div class="formRight" style="flex: 1;">
							<div class="form-group">
								<label class="control-label lableWidth100 marginRight10">英文名</label>
								<input type="text" class="form-control" ref="englishName" placeholder="">
							</div>
							<div class="form-group">
								<label class="control-label lableWidth100 marginRight10">电话</label>
								<input type="text" class="form-control" ref="telephone" placeholder="">
							</div>
						</div>
						<div class="addPCCBtn" style="flex: 0 0 50px;">
							<button type="button" class="btn btn-mini btn-primary timeGroupBtn" @click="_addContact()">新增</button>
						</div>
					</div>
					<!-- 联系人 template -->
					<%@ include file="template/contactTemplate.jspf"%>
					...
					<div class="pccInfoWrapper">
						<div class="pccInfo" style="flex: 1;">
							<div class="formWrapper form-horizontal">
								<div class="formLeft" style="flex: 1;">
									<div class="form-group">
										...
										<input type="text" class="form-control" ref="pcc">
									</div>
									<div class="form-group">
										<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>AccountCode</label> 
										<input type="text" class="form-control" ref="accountCode">
									</div>
								</div>
								<div class="formMiddle" style="flex: 1;">
									<div class="form-group">
										<label for="fitAirline" class="control-label lableWidth100 marginRight10">GDS</label>
										<select ref="gds" class="form-control">
											<option value="AMADEUS">1A(Amadues)</option>
											<option value="TRAVELSKY">1E(Travelsky)</option>
											<option value="GALILEO">1G(Galileo)</option>
										</select>
									</div>
								</div>
								<div class="formRight" style="flex: 1;">
							...
							<!-- 出票PCC -->
							<div class="formWrapper form-horizontal" v-for="(pcc, index) in pccs">
								<div class="formLeft" style="flex: 1;">
									<div class="form-group">
										<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>出票PCC</label> 
										<input type="text" class="form-control" ref="printPcc">
									</div>
									<div class="form-group">
										<label class="control-label lableWidth100 marginRight10 paddingTop0">
											<select ref="mailType" name="" class="form-control span12">
												<option value="QMAIL">Q信箱地址</option>
												<option value="EMAIL">电子邮件地址</option>
											</select>
										</label> 
										<input type="text" class="form-control" ref="mailAddress">
									</div>
								</div>
								<div class="formMiddle" style="flex: 1;">
									<div class="form-group">
										...
										<select ref="printGds" name="" class="form-control">
											<option value="AMADEUS">1A(Amadues)</option>
											<option value="TRAVELSKY">1E(Travelsky)</option>
											<option value="GALILEO">1G(Galileo)</option>
										</select>
									...
									<div class="form-group">
										...
										<select ref="emailTemplate" name="" class="form-control">
											<c:forEach var="value" items="${emailTemplateList}">
								...
								<div class="formRight" style="flex: 1;">
									<div class="form-group">
										<label class="control-label lableWidth100 marginRight10">结算货币</label>
										<select ref="printCurrency" name="" class="form-control">
											<option value="HKD">HKD</option>
											<option value="CNY">CNY</option>
											<option value="USD">USD</option>
										</select>
									...
									<div class="addPCCBtn">
										<button type="button" class="btn btn-mini btn-primary timeGroupBtn" @click="index === 0?_addPcc():_delete(pcc, 'pcc')">{{index === 0?'新增出票PCC':'删除出票PCC'}}</button>
									</div>
								</div>
							</div>
						</div>
						<div class="addGDSBtn">
							<button type="button" class="btn btn-mini btn-primary" @click="addGds">新增GDS</button>
						</div>
					</div>
					<!-- 供应商PCC信息 template -->
					<%@ include file="template/pccTemplate.jspf"%>
					...
					<div class="formWrapper form-horizontal">
						<div class="formItem marginLeft20">
							<div class="form-group">
								...
								<worktime pre-name="printTime"></worktime>
							</div>
							<div class="form-group">
								<h4 class="" style="float: none;">退票</h4>
								<worktime pre-name="refundTime"></worktime>
							</div>
							<div class="form-group">
								<h4 class="" style="float: none;">改签</h4>
								<worktime pre-name="resignTime"></worktime>
							</div>
						</div>
					</div>
					...
					<div class="formWrapper form-horizontal">
						<div class="formItem" style="flex: 1;">
							<div class="form-group">
								<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>模板名称</label> 
								<select id="" name="holidayTemplateId" class="form-control">
					...
					<div class="form-group btnGroup">
						<div class="col-sm-offset-4 col-sm-8">
							<input class="btn btn-danger marginRight20 submit" type="submit" @click="submit()" value="提交"> 
	...
	var vm = new Vue({
		...
		data: {
	  	...
	  	methods: {
	  		...
	  		_addContact() {
	  			let contact = {};
	  			contact.dockingBusiness = this.$refs.dockingBusiness.value;
	  			contact.dockingBusinessText = this.$refs.dockingBusiness.options[this.$refs.dockingBusiness.selectedIndex].text;
	  			contact.email = this.$refs.email.value;
	  			contact.chineseName = this.$refs.chineseName.value;
	  			contact.qq = this.$refs.qq.value;
	  			contact.englishName = this.$refs.englishName.value;
	  			contact.telephone = this.$refs.telephone.value;
	  			this.contacts.push(contact);
	  			console.log(this.contacts);
	  		},
	  		_delete(obj, type) {
	  			if("contact" === type){
	  				this.contacts.remove(obj);
	  			} else if("pcc" === type){
	  				this.pccs.remove(obj);
	  			}
	  		},
	  		_delPrintPcc(_gds, _printPcc) {
	  			_gds.gds.remove(_printPcc);
	  		},
	  		_delGds(_gds) {
	  			this.gdsArr.remove(_gds);
	  		},
	  		_addPcc() {
	  			let pcc = {};
	  			this.pccs.push(pcc);
	  		...
	  		addGds() {
	  			let gds = {};
	  			gds.pcc = this.$refs.pcc.value;
	  			gds.gds = this.$refs.gds.value;
	  			gds.currency = this.$refs.currency.value;
	  			gds.accountCode = this.$refs.accountCode.value;
	  			gds.printPcc = [];
	  			console.log(this.$refs.printPcc.length);
	  			console.log(this.$refs.mailType);
	  			for(let i = 0; i < this.$refs.printPcc.length; i ++) {
	  				let printPcc = {};
	  				printPcc.pcc = this.$refs.printPcc[i].value;
	  				printPcc.printGds = this.$refs.printGds[i].value;
	  				printPcc.printCurrency = this.$refs.printCurrency[i].value;
	  				printPcc.mailType = this.$refs.mailType[i].value;
	  				printPcc.mailTypeText = this.$refs.mailType[i].options[this.$refs.mailType[i].selectedIndex].text;
	  				printPcc.mailAddress = this.$refs.mailAddress[i].value;
	  				printPcc.emailTemplate = this.$refs.emailTemplate[i].value;
	  				printPcc.emailTemplateText = '未选择';
	  				gds.printPcc.push(printPcc);
	  			}
	  			this.gdsArr.push(gds);
	  			console.log(this.gdsArr);
	  		},
	  		submit() {
	  			this.$refs.providerForm.submit();
	  		}
	  	}
	});
