...
<div class="container-fluid" id="main-container">
	<div id="page-content" class="clearfix">
	  <div class="row-fluid">
	     <form action="pricing/${pricing.id == null?'addpricing':'editpricing' }" method="post" id="pricingForm" class="form-horizontal" role="form">
			...
			<div class="formWrapper form-horizontal">
				...
				<div class="formItem relative">
					...
					<div class="form-group">
					    ...
					    <select id="work" name="" class="form-control" v-model="workTime">
				...
				<div class="formItem">
					...
					<div class="form-group">
					    ...
					    <div class="selectAirport">
					    	<a href="#">选择机场</a>
						    <textarea class="form-control" name="departureAirportsInclude" id="departureAirportsInclude" rows="3" cols="25"></textarea>
					    </div>
					    <div class="excludeAirport">
					    	<a href="#">排除机场</a>
						    <textarea class="form-control" name="departureAirportsExclude" id="departureAirportsExclude" rows="3"></textarea>
					    </div>
					</div>
					<div class="form-group">
					    ...
					    <div class="selectAirport">
					    	<a href="#">选择机场</a>
						    <textarea class="form-control" name="arriveAirportsInclude" id="arriveAirportsInclude" rows="3" cols="25"></textarea>
					    </div>
					    <div class="excludeAirport">
					    	<a href="#">排除机场</a>
						    <textarea class="form-control" name="arriveAirportsExclude" id="arriveAirportsExclude" rows="3"></textarea>
					    </div>
					</div>
					<div class="form-group">
					    <label class="control-label lableWidth100 marginRight10">FareBasis</label>
					    <select name="route.fareBasis.fareBasisType" class="form-control span1 marginRight10">
					      <option>请选择</option>
						  <option value="INCLUDE">包含</option>
						  <option value="EXCLUDE">排除</option>
						  <option value="ALL_TRIP_SAME">全程一致</option>
						</select>
						<input type="text" name="route.fareBasis.list" class="form-control span8" id="fareBasis" placeholder="为空时表示没有限制，支持通配符% (可填写，功能未实现)">
					</div>
					<div class="form-group">
			...
			<div class="formWrapper form-horizontal">
				<div class="formItem">
					<div class="form-group clearfix">
					    ...
					    <input type="text" name="specialValue" class="form-control span4" style="" v-show="checkSpecial" />
				    </div>
				    <div class="form-group" v-show="checkCHD">
					    ...
					    <div style="padding-top: 4px;">
						    ...
						    <input type="radio" name="childRewardType" class="form-control" value="BY_ASSIGN"> <span class="paddingLeft20 marginRight20">指定奖励</span></br>
						    ...
						    <input type="radio" name="chdSingleTkt" class="form-control" value="NO_SINGLE_TICKET"> <span class="paddingLeft20">不单开</span>
					    </div>
					</div>
						...
						<div style="display: flex;">
							<div style="flex: 1;">
								<div class="form-group" style="margin-top: 10px;">
									...
									<span>至</span>
									<input class="span10 date-picker billingEndTimeHook" :name="_initName('timeGroups', timeIndex, 'printTktTime.end')" id="billingStartTime" id="billingEndTime" value="" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="结束日期" title=""/>
								</div>
								<div class="form-group">
									...
									<span>至</span>
									<input class="span10 date-picker departureEndTimeHook" :name="_initName('timeGroups', timeIndex, 'departTimes.end')" id="departureEndTime" value="" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="结束日期" title=""/>
								</div>
								<div class="form-group">
						    ...
						    <div style="flex: 1;" class="isReturnTtipHook" v-show="isReturnTtip">
								...
								<div class="form-group">
								    ...
								    <input class="span10 date-picker" :name="_initName('timeGroups', timeIndex, 'deadLineTime')" id="returnDeadLine"  value="" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="开始日期" title=""/>
								</div>
								<div class="form-group">
							...
							<div class="formItem cabinGroupWrapper" id="cabinGroupWrapper">
							    <div class="cabinGroup clearfix" id="cabinGroup1" v-for="(cabinGroup,index) in timeGroup.timeGroup">
									...
									<div class="clearfix" v-show="checkCHD">
										...
										<div class="form-group floatLeft width200">
										    <label for="inputEmail3" class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>代理费</label>
								    		<input type="text" name="_initName('timeGroups.cabinGroups', index, 'chdComission.agencyRatio', timeIndex)" id="chdAgencyFee" class="form-control span3" placeholder="">&nbsp;&nbsp;%
										</div>
										<div class="form-group floatLeft width200">
								    		<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>奖励扣率</label>
								    		<input type="text" name="_initName('timeGroups.cabinGroups', index, 'chdComission.awardRatio', timeIndex)" id="chdRewardDiscountRate" class="form-control span3">&nbsp;&nbsp;%
										</div>
										<div class="form-group floatLeft width200" v-show="isOneWay && checkCHD">
								    		<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>单程奖励金额</label>
								    		<input type="text" name="_initName('timeGroups.cabinGroups', index, 'chdComission.owAwardMoney', timeIndex)" id="chdOneWayReward" class="form-control span3">&nbsp;&nbsp;元
										</div>
										<div class="form-group floatLeft width200" v-show="isReturnTtip && checkCHD">
								    		<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>往返奖励金额</label>
								    		<input type="text" name="_initName('timeGroups.cabinGroups', index, 'chdComission.rtAwardMoney', timeIndex)" id="chdRoundTripReward" class="form-control span3">&nbsp;&nbsp;元
										</div>
										<div class="form-group floatLeft width200">
								    		<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>开票费</label>
								    		<input type="text" name="_initName('timeGroups.cabinGroups', index, 'chdComission.tktFee', timeIndex)" id="chdBillingFare" class="form-control span3">&nbsp;&nbsp;元
										</div>
									</div>
									<div class="clearfix" v-show="checkBaby">
										...
										<div class="form-group floatLeft width200">
								    		<label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>开票费</label>
								    		<input type="text" name="_initName('timeGroups.cabinGroups', index, 'babyCommission.tktFee', timeIndex)" id="babyBillingFare" class="form-control span3">&nbsp;&nbsp;元
										</div>
									</div>
									<div class="form-group" style="display: block;">
									    <label class="control-label lableWidth100 marginRight10"><i class="colorRed">*</i>适用舱位</label>
										<input type="text" name="_initName('timeGroups.cabinGroups', index, 'fitCabin', timeIndex)" id="fitCabin" class="form-control marginRight20 span8" placeholder="">
	...
	$(document).ready(function(){
		var vm = new Vue({
		  ...
		  data: {
		    ...
		    checkSpecial: false,
		    isTransfer: false,
		    timeGroups: [{"timeGroup": [{"cabinGroup": "1"}]}],
		    workTime: '0'
		  },
		  methods: {
