...
<body>
	...
	<script type="text/javascript">
		var bathPath = '${pageContext.request.contextPath}';
		//服务器校验
		function severCheck(){
			if(check()){
				...
				$.ajax({
					...
					success: function(data){
						...
						if(0 == data.status){
							saveCookie();
							window.location.href= bathPath + "/main/index";
		...
		function changeCode() {
			$("#codeImg").attr("src", "${pageContext.request.contextPath}/getCode?t=" + genTimestamp());
		}
